; ModuleID = '/home/goossens/goossens-springer-book/2022.1/book_experiments/simple_pipeline_ip/simple_pipeline_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_simple_pipeline_ip_ir(i32 %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="65536" %code_ram, i32* noalias nonnull "fpga.decayed.dim.hint"="65536" %data_ram, i32* noalias nocapture nonnull %nb_instruction) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_simple_pipeline_ip_hw(i32 %start_pc, i32* %2, i32* %3, i32* %nb_instruction_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([65536 x i32]* noalias, [65536 x i32]* noalias readonly, [65536 x i32]* noalias, [65536 x i32]* noalias readonly, i32* noalias, i32* noalias readonly align 512) unnamed_addr #3 {
entry:
...
declare void @apatb_simple_pipeline_ip_hw(i32, i32*, i32*, i32*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([65536 x i32]* noalias, [65536 x i32]* noalias readonly, [65536 x i32]* noalias, [65536 x i32]* noalias readonly, i32* noalias, i32* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a65536i32([65536 x i32]* %2, [65536 x i32]* %3)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %4, i32* align 512 %5)
  ret void
...
define void @simple_pipeline_ip_hw_stub_wrapper(i32, i32*, i32*, i32*) #4 {
entry:
  %4 = bitcast i32* %1 to [65536 x i32]*
  %5 = bitcast i32* %2 to [65536 x i32]*
  call void @copy_out([65536 x i32]* null, [65536 x i32]* %4, [65536 x i32]* null, [65536 x i32]* %5, i32* null, i32* %3)
  %6 = bitcast [65536 x i32]* %4 to i32*
  %7 = bitcast [65536 x i32]* %5 to i32*
  call void @simple_pipeline_ip_hw_stub(i32 %0, i32* %6, i32* %7, i32* %3)
  call void @copy_in([65536 x i32]* null, [65536 x i32]* %4, [65536 x i32]* null, [65536 x i32]* %5, i32* null, i32* %3)
  ret void
}

declare void @simple_pipeline_ip_hw_stub(i32, i32*, i32*, i32*)
