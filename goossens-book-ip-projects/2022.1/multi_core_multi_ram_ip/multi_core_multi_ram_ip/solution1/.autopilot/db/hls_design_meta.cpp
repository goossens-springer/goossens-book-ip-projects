...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("local_ram_Addr_A", 32, hls_out, 2, "bram", "MemPortADDR2", 1),
	Port_Property("local_ram_EN_A", 1, hls_out, 2, "bram", "MemPortCE2", 1),
	Port_Property("local_ram_WEN_A", 4, hls_out, 2, "bram", "MemPortWE2", 1),
	Port_Property("local_ram_Din_A", 32, hls_out, 2, "bram", "MemPortDIN2", 1),
	Port_Property("local_ram_Dout_A", 32, hls_in, 2, "bram", "MemPortDOUT2", 1),
	Port_Property("local_ram_Clk_A", 1, hls_out, 2, "bram", "mem_clk", 1),
	Port_Property("local_ram_Rst_A", 1, hls_out, 2, "bram", "mem_rst", 1),
...
const char* HLS_Design_Meta::dut_name = "multi_core_multi_ram_ip";
