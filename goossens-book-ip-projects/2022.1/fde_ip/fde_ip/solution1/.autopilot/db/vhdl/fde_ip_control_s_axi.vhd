...
entity fde_ip_control_s_axi is
generic (
...
end entity fde_ip_control_s_axi;
...
architecture behave of fde_ip_control_s_axi is
    ...
    component fde_ip_control_s_axi_ram is
        generic (
    ...
    end component fde_ip_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_code_ram
int_code_ram : fde_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
entity fde_ip_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity fde_ip_control_s_axi_ram;

architecture behave of fde_ip_control_s_axi_ram is
