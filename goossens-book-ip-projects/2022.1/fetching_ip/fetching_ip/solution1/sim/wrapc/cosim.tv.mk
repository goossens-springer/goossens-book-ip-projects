...
AUTOPILOT_ROOT := /home/bernard/Vitis/Vitis/2020.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/bernard/Vitis/Vivado/2020.1/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/testbench_fetching_ip.cpp_pre.cpp.tb.o : testbench_fetching_ip.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling testbench_fetching_ip.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fetching_ip.cpp_pre.cpp.tb.o : fetching_ip.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fetching_ip.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
