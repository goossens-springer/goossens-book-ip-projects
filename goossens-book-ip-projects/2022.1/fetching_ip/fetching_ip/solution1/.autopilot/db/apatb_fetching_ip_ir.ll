; ModuleID = '/home/goossens/goossens-springer-book/2022.1/book_experiments/fetching_ip/fetching_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_fetching_ip_ir(i32 %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="65536" %code_ram) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([65536 x i32]* nonnull %0, [65536 x i32]* %code_ram_copy)
  %1 = getelementptr inbounds [65536 x i32], [65536 x i32]* %code_ram_copy, i32 0, i32 0
  call void @apatb_fetching_ip_hw(i32 %start_pc, i32* %1)
  call void @copy_back([65536 x i32]* %0, [65536 x i32]* %code_ram_copy)
...
define internal fastcc void @copy_in([65536 x i32]* noalias readonly, [65536 x i32]* noalias) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([65536 x i32]* noalias, [65536 x i32]* noalias readonly) unnamed_addr #3 {
entry:
...
declare void @apatb_fetching_ip_hw(i32, i32*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([65536 x i32]* noalias, [65536 x i32]* noalias readonly) unnamed_addr #3 {
entry:
  ret void
}

define void @fetching_ip_hw_stub_wrapper(i32, i32*) #4 {
entry:
  %2 = bitcast i32* %1 to [65536 x i32]*
  call void @copy_out([65536 x i32]* null, [65536 x i32]* %2)
  %3 = bitcast [65536 x i32]* %2 to i32*
  call void @fetching_ip_hw_stub(i32 %0, i32* %3)
  call void @copy_in([65536 x i32]* null, [65536 x i32]* %2)
  ret void
}

declare void @fetching_ip_hw_stub(i32, i32*)
