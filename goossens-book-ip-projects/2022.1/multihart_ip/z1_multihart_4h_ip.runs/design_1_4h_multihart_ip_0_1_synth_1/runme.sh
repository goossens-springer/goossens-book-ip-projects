...
HD_PWD='/home/bernard/book-2022.1/new_book_ip/multihart_ip/z1_multihart_4h_ip.runs/design_1_4h_multihart_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_4h_multihart_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_4h_multihart_ip_0_1.tcl
