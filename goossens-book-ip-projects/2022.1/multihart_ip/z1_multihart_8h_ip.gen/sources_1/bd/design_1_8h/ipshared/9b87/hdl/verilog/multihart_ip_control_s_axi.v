...
#(parameter
    ...
    input  wire [2:0]                    start_pc_address0,
...
localparam
    ...
    ADDR_NB_INSTRUCTION_DATA_0   = 20'h00040,
    ADDR_NB_INSTRUCTION_CTRL     = 20'h00044,
    ADDR_NB_CYCLE_DATA_0         = 20'h00050,
    ADDR_NB_CYCLE_CTRL           = 20'h00054,
    ADDR_START_PC_BASE           = 20'h00020,
    ADDR_START_PC_HIGH           = 20'h0003f,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [2:0]                    int_start_pc_address0;
    wire                          int_start_pc_ce0;
    wire [31:0]                   int_start_pc_q0;
    wire [2:0]                    int_start_pc_address1;
...
assign int_start_pc_address1 = ar_hs? raddr[4:2] : waddr[4:2];
