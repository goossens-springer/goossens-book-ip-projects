...
HD_PWD='/home/bernard/book/new_book_ip/multicore_multicycle_ip/z1_multicore_multicycle_4c_ip.runs/design_1_4c_blk_mem_gen_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_4c_blk_mem_gen_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_4c_blk_mem_gen_0_2.tcl
