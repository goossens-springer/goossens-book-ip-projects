...
void XMultihart_ip_Set_ip_num(XMultihart_ip *InstancePtr, u32 Data) {
    ...
    XMultihart_ip_WriteReg(InstancePtr->Control_BaseAddress, XMULTIHART_IP_CONTROL_ADDR_IP_NUM_DATA, Data);
}
...
u32 XMultihart_ip_Get_ip_num(XMultihart_ip *InstancePtr) {
    ...
    Data = XMultihart_ip_ReadReg(InstancePtr->Control_BaseAddress, XMULTIHART_IP_CONTROL_ADDR_IP_NUM_DATA);
    return Data;
}
...
void XMultihart_ip_Set_data_ram(XMultihart_ip *InstancePtr, u64 Data) {
    ...
    XMultihart_ip_WriteReg(InstancePtr->Control_BaseAddress, XMULTIHART_IP_CONTROL_ADDR_DATA_RAM_DATA, (u32)(Data));
    XMultihart_ip_WriteReg(InstancePtr->Control_BaseAddress, XMULTIHART_IP_CONTROL_ADDR_DATA_RAM_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMultihart_ip_Get_data_ram(XMultihart_ip *InstancePtr) {
    ...
    Data = XMultihart_ip_ReadReg(InstancePtr->Control_BaseAddress, XMULTIHART_IP_CONTROL_ADDR_DATA_RAM_DATA);
    Data += (u64)XMultihart_ip_ReadReg(InstancePtr->Control_BaseAddress, XMULTIHART_IP_CONTROL_ADDR_DATA_RAM_DATA + 4) << 32;
    return Data;
}
...
u32 XMultihart_ip_Get_ip_code_ram_BaseAddress(XMultihart_ip *InstancePtr) {
    ...
    return (InstancePtr->Control_BaseAddress + XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE);
}
...
u32 XMultihart_ip_Get_ip_code_ram_HighAddress(XMultihart_ip *InstancePtr) {
    ...
    return (InstancePtr->Control_BaseAddress + XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_HIGH);
}
...
u32 XMultihart_ip_Get_ip_code_ram_TotalBytes(XMultihart_ip *InstancePtr) {
    ...
    return (XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_HIGH - XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + 1);
}
...
u32 XMultihart_ip_Get_ip_code_ram_BitWidth(XMultihart_ip *InstancePtr) {
    ...
    return XMULTIHART_IP_CONTROL_WIDTH_IP_CODE_RAM;
}
...
u32 XMultihart_ip_Get_ip_code_ram_Depth(XMultihart_ip *InstancePtr) {
    ...
    return XMULTIHART_IP_CONTROL_DEPTH_IP_CODE_RAM;
}
...
u32 XMultihart_ip_Write_ip_code_ram_Words(XMultihart_ip *InstancePtr, int offset, word_type *data, int length) {
    ...
    if ((offset + length)*4 > (XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_HIGH - XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Control_BaseAddress + XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XMultihart_ip_Read_ip_code_ram_Words(XMultihart_ip *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Control_BaseAddress + XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XMultihart_ip_Write_ip_code_ram_Bytes(XMultihart_ip *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_HIGH - XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Control_BaseAddress + XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XMultihart_ip_Read_ip_code_ram_Bytes(XMultihart_ip *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Control_BaseAddress + XMULTIHART_IP_CONTROL_ADDR_IP_CODE_RAM_BASE + offset + i);
    }
    return length;
}
