...
#define XPAR_XMULTIHART_IP_NUM_INSTANCES 1

/* Definitions for peripheral MULTIHART_IP_0 */
#define XPAR_MULTIHART_IP_0_COMPATIBLE "xlnx,multihart-ip-1.0"
#define XPAR_MULTIHART_IP_0_BASEADDR 0x40000000
#define XPAR_MULTIHART_IP_0_HIGHADDR 0x4001ffff

/* Canonical definitions for peripheral MULTIHART_IP_0 */
#define XPAR_XMULTIHART_IP_0_BASEADDR 0x40000000
#define XPAR_XMULTIHART_IP_0_HIGHADDR 0x4001ffff
#define XPAR_XMULTIHART_IP_0_COMPATIBLE "xlnx,multihart-ip-1.0"
