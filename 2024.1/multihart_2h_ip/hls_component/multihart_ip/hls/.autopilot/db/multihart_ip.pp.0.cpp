...
typedef ap_uint<(15 -1)> w_hart_data_address_t;
typedef ap_uint<(15 -1)+1> h_hart_data_address_t;
typedef ap_uint<(15 -1)+2> b_hart_data_address_t;
...
static void init_file(
  ...
  reg_num_p1_t r1;
  reg_num_t r;
  VITIS_LOOP_30_1: for (h1=0; h1<(1<<1); h1++){
#pragma HLS UNROLL
 h = h1;
