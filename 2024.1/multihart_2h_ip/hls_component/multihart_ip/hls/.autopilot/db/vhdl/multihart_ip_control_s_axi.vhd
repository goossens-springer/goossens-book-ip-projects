...
-- 0x00014 : reserved
-- 0x00020 : Data signal of nb_instruction
--           bit 31~0 - nb_instruction[31:0] (Read)
-- 0x00024 : Control signal of nb_instruction
--           bit 0  - nb_instruction_ap_vld (Read/COR)
--           others - reserved
-- 0x00030 : Data signal of nb_cycle
--           bit 31~0 - nb_cycle[31:0] (Read)
-- 0x00034 : Control signal of nb_cycle
--           bit 0  - nb_cycle_ap_vld (Read/COR)
--           others - reserved
-- 0x00018 ~
-- 0x0001f : Memory 'start_pc' (2 * 32b)
...
architecture behave of multihart_ip_control_s_axi is
    ...
    constant ADDR_RUNNING_HART_SET_DATA_0 : INTEGER := 16#00010#;
    constant ADDR_RUNNING_HART_SET_CTRL   : INTEGER := 16#00014#;
    constant ADDR_NB_INSTRUCTION_DATA_0   : INTEGER := 16#00020#;
    constant ADDR_NB_INSTRUCTION_CTRL     : INTEGER := 16#00024#;
    constant ADDR_NB_CYCLE_DATA_0         : INTEGER := 16#00030#;
    constant ADDR_NB_CYCLE_CTRL           : INTEGER := 16#00034#;
    constant ADDR_START_PC_BASE           : INTEGER := 16#00018#;
    constant ADDR_START_PC_HIGH           : INTEGER := 16#0001f#;
    constant ADDR_CODE_RAM_BASE           : INTEGER := 16#20000#;
    constant ADDR_CODE_RAM_HIGH           : INTEGER := 16#3ffff#;
    constant ADDR_DATA_RAM_BASE           : INTEGER := 16#40000#;
    constant ADDR_DATA_RAM_HIGH           : INTEGER := 16#5ffff#;
    ...
    signal int_code_ram_address0 : UNSIGNED(14 downto 0);
    signal int_code_ram_ce0    : STD_LOGIC;
    signal int_code_ram_q0     : UNSIGNED(31 downto 0);
    signal int_code_ram_address1 : UNSIGNED(14 downto 0);
    ...
    signal int_data_ram_address0 : UNSIGNED(14 downto 0);
    ...
    signal int_data_ram_address1 : UNSIGNED(14 downto 0);
...
port map (
     ...
     q1        => int_start_pc_q1);
-- int_code_ram
int_code_ram : multihart_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_code_ram_q1);
-- int_data_ram
int_data_ram : multihart_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "T2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_start_pc_read = '0') and (int_code_ram_read = '0') and (int_data_ram_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    int_code_ram_address1 <= raddr(16 downto 2) when ar_hs = '1' else waddr(16 downto 2);
    ...
    int_data_ram_address1 <= raddr(16 downto 2) when ar_hs = '1' else waddr(16 downto 2);
