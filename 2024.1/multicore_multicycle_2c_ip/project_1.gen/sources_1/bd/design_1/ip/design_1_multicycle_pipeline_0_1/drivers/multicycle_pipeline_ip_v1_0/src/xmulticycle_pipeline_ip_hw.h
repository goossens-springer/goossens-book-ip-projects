...
#define XMULTICYCLE_PIPELINE_IP_CONTROL_ADDR_IP_CODE_RAM_BASE    0x10000
#define XMULTICYCLE_PIPELINE_IP_CONTROL_ADDR_IP_CODE_RAM_HIGH    0x1ffff
#define XMULTICYCLE_PIPELINE_IP_CONTROL_WIDTH_IP_CODE_RAM        32
#define XMULTICYCLE_PIPELINE_IP_CONTROL_DEPTH_IP_CODE_RAM        16384
