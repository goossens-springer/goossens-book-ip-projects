...
HLS_SOURCES = ../../../../../../testbench_par_multicore_multicycle_ip.cpp ../../../../../../wb.cpp ../../../../../../type.cpp ../../../../../../print.cpp ../../../../../../new_cycle.cpp ../../../../../../multicycle_pipeline_ip.cpp ../../../../../../mem_access.cpp ../../../../../../mem.cpp ../../../../../../issue.cpp ../../../../../../immediate.cpp ../../../../../../fetch.cpp ../../../../../../execute.cpp ../../../../../../emulate.cpp ../../../../../../disassemble.cpp ../../../../../../decode.cpp ../../../../../../compute.cpp

override TARGET := csim.exe

AUTOPILOT_ROOT := /opt/Xilinx/Vitis_HLS/2024.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /opt/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/bin
endif
...
CCFLAG += --gcc-toolchain=/opt/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0
CCFLAG += -Werror=uninitialized
CCFLAG += -Wno-c++11-narrowing
CCFLAG += -Wno-error=sometimes-uninitialized
LFLAG += --gcc-toolchain=/opt/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/testbench_par_multicore_multicycle_ip.o: ../../../../../../testbench_par_multicore_multicycle_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../testbench_par_multicore_multicycle_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_par_multicore_multicycle_ip.d
...
$(ObjDir)/new_cycle.o: ../../../../../../new_cycle.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../new_cycle.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/new_cycle.d

$(ObjDir)/multicycle_pipeline_ip.o: ../../../../../../multicycle_pipeline_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../multicycle_pipeline_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/multicycle_pipeline_ip.d

$(ObjDir)/mem_access.o: ../../../../../../mem_access.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../mem_access.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mem_access.d
...
$(ObjDir)/issue.o: ../../../../../../issue.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../issue.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/issue.d
