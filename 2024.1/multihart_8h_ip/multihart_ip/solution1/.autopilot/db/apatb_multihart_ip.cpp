...
#define AUTOTB_TVIN_code_ram "../tv/cdatafile/c.multihart_ip.autotvin_code_ram.dat"
#define AUTOTB_TVOUT_code_ram "../tv/cdatafile/c.multihart_ip.autotvout_code_ram.dat"
...
#define AUTOTB_TVOUT_PC_code_ram "../tv/rtldatafile/rtl.multihart_ip.autotvout_code_ram.dat"
...
extern "C" void multihart_ip_hw_stub_wrapper(int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
tr.import<4>((char*)__xlx_apatb_param_start_pc, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_start_pc, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.start_pc_depth);
#else
...
multihart_ip_hw_stub_wrapper(__xlx_apatb_param_running_hart_set, __xlx_apatb_param_start_pc, __xlx_apatb_param_code_ram, __xlx_apatb_param_data_ram, __xlx_apatb_param_nb_instruction, __xlx_apatb_param_nb_cycle);
