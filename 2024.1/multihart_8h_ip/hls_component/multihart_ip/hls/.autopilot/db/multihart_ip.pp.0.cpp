...
typedef ap_uint<(15 -3)> w_hart_data_address_t;
typedef ap_uint<(15 -3)+1> h_hart_data_address_t;
typedef ap_uint<(15 -3)+2> b_hart_data_address_t;
...
static void init_file(
  ...
  reg_num_p1_t r1;
  reg_num_t r;
  VITIS_LOOP_30_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
...
static void init_exit(
  ...
  hart_num_t h;
  bit_t h_running;
  VITIS_LOOP_52_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
...
static void running_cond_update(
  ...
  bit_t cond;
  cond = 0;
  VITIS_LOOP_66_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
