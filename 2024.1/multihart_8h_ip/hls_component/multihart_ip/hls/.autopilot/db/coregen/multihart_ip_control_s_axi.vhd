...
architecture behave of multihart_ip_control_s_axi is
    ...
    constant ADDR_NB_INSTRUCTION_DATA_0   : INTEGER := 16#00040#;
    constant ADDR_NB_INSTRUCTION_CTRL     : INTEGER := 16#00044#;
    constant ADDR_NB_CYCLE_DATA_0         : INTEGER := 16#00050#;
    constant ADDR_NB_CYCLE_CTRL           : INTEGER := 16#00054#;
    constant ADDR_START_PC_BASE           : INTEGER := 16#00020#;
    constant ADDR_START_PC_HIGH           : INTEGER := 16#0003f#;
    ...
    -- memory signals
    signal int_start_pc_address0 : UNSIGNED(2 downto 0);
    signal int_start_pc_ce0    : STD_LOGIC;
    signal int_start_pc_q0     : UNSIGNED(31 downto 0);
    signal int_start_pc_address1 : UNSIGNED(2 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_start_pc_address1 <= raddr(4 downto 2) when ar_hs = '1' else waddr(4 downto 2);
