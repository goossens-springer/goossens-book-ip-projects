...
entity simple_pipeline_ip_control_s_axi is
generic (
...
end entity simple_pipeline_ip_control_s_axi;
...
architecture behave of simple_pipeline_ip_control_s_axi is
    ...
    component simple_pipeline_ip_control_s_axi_ram is
        generic (
    ...
    end component simple_pipeline_ip_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_code_ram
int_code_ram : simple_pipeline_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_code_ram_q1);
-- int_data_ram
int_data_ram : simple_pipeline_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "T2P",
     BYTES     => 4,
...
entity simple_pipeline_ip_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity simple_pipeline_ip_control_s_axi_ram;

architecture behave of simple_pipeline_ip_control_s_axi_ram is
