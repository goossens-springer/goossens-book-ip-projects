...
#define XMULTIHART_IP_CONTROL_ADDR_DATA_RAM_DATA         0x00030
#define XMULTIHART_IP_CONTROL_BITS_DATA_RAM_DATA         64
#define XMULTIHART_IP_CONTROL_ADDR_NB_INSTRUCTION_DATA   0x0003c
#define XMULTIHART_IP_CONTROL_BITS_NB_INSTRUCTION_DATA   32
#define XMULTIHART_IP_CONTROL_ADDR_NB_INSTRUCTION_CTRL   0x00040
#define XMULTIHART_IP_CONTROL_ADDR_NB_CYCLE_DATA         0x0004c
#define XMULTIHART_IP_CONTROL_BITS_NB_CYCLE_DATA         32
#define XMULTIHART_IP_CONTROL_ADDR_NB_CYCLE_CTRL         0x00050
#define XMULTIHART_IP_CONTROL_ADDR_START_PC_BASE         0x00020
#define XMULTIHART_IP_CONTROL_ADDR_START_PC_HIGH         0x0002f
#define XMULTIHART_IP_CONTROL_WIDTH_START_PC             32
#define XMULTIHART_IP_CONTROL_DEPTH_START_PC             4
