...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("ip_data_ram_Addr_A", 32, hls_out, 5, "bram", "MemPortADDR2", 1),
	Port_Property("ip_data_ram_EN_A", 1, hls_out, 5, "bram", "MemPortCE2", 1),
	Port_Property("ip_data_ram_WEN_A", 4, hls_out, 5, "bram", "MemPortWE2", 1),
	Port_Property("ip_data_ram_Din_A", 32, hls_out, 5, "bram", "MemPortDIN2", 1),
	Port_Property("ip_data_ram_Dout_A", 32, hls_in, 5, "bram", "MemPortDOUT2", 1),
	Port_Property("ip_data_ram_Clk_A", 1, hls_out, 5, "bram", "mem_clk", 1),
	Port_Property("ip_data_ram_Rst_A", 1, hls_out, 5, "bram", "mem_rst", 1),
