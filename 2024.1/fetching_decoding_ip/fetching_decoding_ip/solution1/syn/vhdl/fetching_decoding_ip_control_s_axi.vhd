...
entity fetching_decoding_ip_control_s_axi is
generic (
...
end entity fetching_decoding_ip_control_s_axi;
...
architecture behave of fetching_decoding_ip_control_s_axi is
    ...
    component fetching_decoding_ip_control_s_axi_ram is
        generic (
    ...
    end component fetching_decoding_ip_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_code_ram
int_code_ram : fetching_decoding_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_code_ram_read = '0') else '0';
    RVALID    <= RVALID_t;
...
entity fetching_decoding_ip_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity fetching_decoding_ip_control_s_axi_ram;

architecture behave of fetching_decoding_ip_control_s_axi_ram is
