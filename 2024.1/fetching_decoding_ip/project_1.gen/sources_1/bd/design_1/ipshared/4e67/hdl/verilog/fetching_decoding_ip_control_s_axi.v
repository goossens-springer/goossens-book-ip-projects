...
// ==============================================================
`timescale 1ns/1ps
module fetching_decoding_ip_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                   = 18'h00008,
    ADDR_ISR                   = 18'h0000c,
    ADDR_START_PC_DATA_0       = 18'h00010,
    ADDR_START_PC_CTRL         = 18'h00014,
    ADDR_NB_INSTRUCTION_DATA_0 = 18'h00018,
    ADDR_NB_INSTRUCTION_CTRL   = 18'h0001c,
    ADDR_CODE_RAM_BASE         = 18'h20000,
    ADDR_CODE_RAM_HIGH         = 18'h3ffff,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
...
//------------------------Instantiation------------------
// int_code_ram
fetching_decoding_ip_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 32768 )
...
assign RVALID  = (rstate == RDDATA) & !int_code_ram_read;
...
module fetching_decoding_ip_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
