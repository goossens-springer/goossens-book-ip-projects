...
typedef ap_uint<((16 -1)-1)> w_hart_data_address_t;
typedef ap_uint<((16 -1)-1)+1> h_hart_data_address_t;
typedef ap_uint<((16 -1)-1)+2> b_hart_data_address_t;
...
__attribute__((sdx_kernel("multihart_ip", 0))) void multihart_ip(
  ...
  int ip_data_ram[(1<<1)][(1<<((16 -1)-1))],
  int data_ram [(1<<1)][(1<<1)][(1<<((16 -1)-1))],
...
void mem_access(
  ...
  int ip_data_ram[][(1<<((16 -1)-1))],
  int data_ram[][(1<<1)][(1<<((16 -1)-1))],
  m_state_t *m_state,
  from_m_to_w_t *m_to_w,
  bit_t *m_state_is_full);
