...
# 2 "<built-in>" 2
# 1 "multi_core_multi_ram_ip.cpp" 2
...
# 2 "multi_core_multi_ram_ip.cpp" 2
# 1 "./multi_core_multi_ram_ip.h" 1
# 1 "/opt/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/ap_int.h" 1
# 2 "./multi_core_multi_ram_ip.h" 2
...
typedef ap_uint<1 +1> ip_num_p1_t;
typedef ap_uint<1> ip_num_t;
# 3 "multi_core_multi_ram_ip.cpp" 2
__attribute__((sdx_kernel("multi_core_multi_ram_ip", 0))) void multi_core_multi_ram_ip(
  int ip_num,
  int local_ram[(1<<(16 - 1))],
  int data_ram [(1<<16)]){
#line 15 "/home/goossens/goossens-springer-book/2022.1/book_experiments/multi_core_multi_ram_ip/multi_core_multi_ram_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=multi_core_multi_ram_ip
# 6 "multi_core_multi_ram_ip.cpp"

#line 6 "/home/goossens/goossens-springer-book/2022.1/book_experiments/multi_core_multi_ram_ip/multi_core_multi_ram_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=multi_core_multi_ram_ip
# 6 "multi_core_multi_ram_ip.cpp"
...
#pragma HLS INTERFACE s_axilite port=return
 ip_num_t ip;
  ...
  ap_uint<5> i;
  ap_uint<1> i0;
  ap_uint<16> offset, i_div_2;
  unsigned int global_address, local_address;
  ip = ip_num;
  next_ip = (ip_num_p1_t)ip + 1;
  offset =
   (((ap_uint<16>)next_ip)<<(16 - 1)) + 8;
  VITIS_LOOP_23_1: for (i=0; i<16; i++){
