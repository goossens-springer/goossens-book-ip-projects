...
#define XFETCHING_IP_CONTROL_ADDR_CODE_RAM_BASE 0x20000
#define XFETCHING_IP_CONTROL_ADDR_CODE_RAM_HIGH 0x3ffff
#define XFETCHING_IP_CONTROL_WIDTH_CODE_RAM     32
#define XFETCHING_IP_CONTROL_DEPTH_CODE_RAM     32768
