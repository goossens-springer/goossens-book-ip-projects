...
set C_modelArgList {
	...
	{ empty_19 int 14 regular  }
	{ empty_20 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "has_exited_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "empty_19", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "empty_20", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ empty_19 sc_in sc_lv 14 signal 2 } 
	{ empty_20 sc_in sc_lv 14 signal 3 } 
	...
	{ shl_i_i_i sc_in sc_lv 3 signal 11 } 
	{ empty sc_in sc_lv 2 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_19", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "empty_19", "role": "default" }} , 
 	{ "name": "empty_20", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "empty_20", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	empty_19 { ap_none {  { empty_19 in_data 0 14 } } }
	empty_20 { ap_none {  { empty_20 in_data 0 14 } } }
	...
	ip_code_ram { ap_memory {  { ip_code_ram_address0 mem_address 1 14 }  { ip_code_ram_ce0 mem_ce 1 1 }  { ip_code_ram_q0 mem_dout 0 32 } } }
