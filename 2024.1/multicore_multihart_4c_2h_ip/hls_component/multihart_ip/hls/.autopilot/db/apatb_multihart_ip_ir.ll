; ModuleID = '/home/goossens/goossens-book-ip-projects/2024.1/multicore_multihart_4c_2h_ip/workspace/hls_component/multihart_ip/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_multihart_ip_ir(i32 %ip_num, i32 %running_hart_set, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2" %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16384" %ip_code_ram, [8192 x i32]* noalias nonnull "fpga.decayed.dim.hint"="2" %ip_data_ram, [2 x [8192 x i32]]* noalias nonnull "fpga.decayed.dim.hint"="4" "maxi" %data_ram, i32* noalias nocapture nonnull %nb_instruction, i32* noalias nocapture nonnull %nb_cycle) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_multihart_ip_hw(i32 %ip_num, i32 %running_hart_set, [2 x i32]* %start_pc_copy, [16384 x i32]* %ip_code_ram_copy, [2 x [8192 x i32]]* %ip_data_ram_copy, [4 x [2 x [8192 x i32]]]* %data_ram_copy, i32* %nb_instruction_copy, i32* %nb_cycle_copy)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a2a8192i32([2 x [8192 x i32]]* noalias %dst, [2 x [8192 x i32]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [2 x [8192 x i32]]* %dst, null
  %1 = icmp eq [2 x [8192 x i32]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a2a8192i32([2 x [8192 x i32]]* nonnull %dst, [2 x [8192 x i32]]* nonnull %src, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a2a8192i32([2 x [8192 x i32]]* %dst, [2 x [8192 x i32]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [2 x [8192 x i32]]* %src, null
  %1 = icmp eq [2 x [8192 x i32]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [2 x [8192 x i32]], [2 x [8192 x i32]]* %dst, i64 0, i64 %for.loop.idx2
  %src.addr = getelementptr [2 x [8192 x i32]], [2 x [8192 x i32]]* %src, i64 0, i64 %for.loop.idx2
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a4a2a8192i32([4 x [2 x [8192 x i32]]]* noalias %dst, [4 x [2 x [8192 x i32]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [4 x [2 x [8192 x i32]]]* %dst, null
  %1 = icmp eq [4 x [2 x [8192 x i32]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a4a2a8192i32([4 x [2 x [8192 x i32]]]* nonnull %dst, [4 x [2 x [8192 x i32]]]* nonnull %src, i64 4)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a4a2a8192i32([4 x [2 x [8192 x i32]]]* %dst, [4 x [2 x [8192 x i32]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [4 x [2 x [8192 x i32]]]* %src, null
  %1 = icmp eq [4 x [2 x [8192 x i32]]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [4 x [2 x [8192 x i32]]], [4 x [2 x [8192 x i32]]]* %dst, i64 0, i64 %for.loop.idx2
  %src.addr = getelementptr [4 x [2 x [8192 x i32]]], [4 x [2 x [8192 x i32]]]* %src, i64 0, i64 %for.loop.idx2
  call void @arraycpy_hls.p0a2a8192i32([2 x [8192 x i32]]* %dst.addr, [2 x [8192 x i32]]* %src.addr, i64 2)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([2 x i32]* noalias, [2 x i32]* noalias readonly align 512, [16384 x i32]* noalias, [16384 x i32]* noalias readonly, [2 x [8192 x i32]]* noalias, [2 x [8192 x i32]]* noalias readonly, [4 x [2 x [8192 x i32]]]* noalias, [4 x [2 x [8192 x i32]]]* noalias readonly, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_multihart_ip_hw(i32, i32, [2 x i32]*, [16384 x i32]*, [2 x [8192 x i32]]*, [4 x [2 x [8192 x i32]]]*, i32*, i32*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([2 x i32]* noalias, [2 x i32]* noalias readonly align 512, [16384 x i32]* noalias, [16384 x i32]* noalias readonly, [2 x [8192 x i32]]* noalias, [2 x [8192 x i32]]* noalias readonly, [4 x [2 x [8192 x i32]]]* noalias, [4 x [2 x [8192 x i32]]]* noalias readonly, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a2a8192i32([2 x [8192 x i32]]* %4, [2 x [8192 x i32]]* %5)
  call fastcc void @onebyonecpy_hls.p0a4a2a8192i32([4 x [2 x [8192 x i32]]]* %6, [4 x [2 x [8192 x i32]]]* %7)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %8, i32* align 512 %9)
...
define void @multihart_ip_hw_stub_wrapper(i32, i32, [2 x i32]*, [16384 x i32]*, [2 x [8192 x i32]]*, [4 x [2 x [8192 x i32]]]*, i32*, i32*) #5 {
entry:
  call void @copy_out([2 x i32]* null, [2 x i32]* %2, [16384 x i32]* null, [16384 x i32]* %3, [2 x [8192 x i32]]* null, [2 x [8192 x i32]]* %4, [4 x [2 x [8192 x i32]]]* null, [4 x [2 x [8192 x i32]]]* %5, i32* null, i32* %6, i32* null, i32* %7)
  %8 = bitcast [2 x i32]* %2 to i32*
  %9 = bitcast [16384 x i32]* %3 to i32*
  %10 = bitcast [2 x [8192 x i32]]* %4 to [8192 x i32]*
  %11 = bitcast [4 x [2 x [8192 x i32]]]* %5 to [2 x [8192 x i32]]*
  call void @multihart_ip_hw_stub(i32 %0, i32 %1, i32* %8, i32* %9, [8192 x i32]* %10, [2 x [8192 x i32]]* %11, i32* %6, i32* %7)
  call void @copy_in([2 x i32]* null, [2 x i32]* %2, [16384 x i32]* null, [16384 x i32]* %3, [2 x [8192 x i32]]* null, [2 x [8192 x i32]]* %4, [4 x [2 x [8192 x i32]]]* null, [4 x [2 x [8192 x i32]]]* %5, i32* null, i32* %6, i32* null, i32* %7)
  ret void
}

declare void @multihart_ip_hw_stub(i32, i32, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, [8192 x i32]* noalias nonnull, [2 x [8192 x i32]]* noalias nonnull, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull)
