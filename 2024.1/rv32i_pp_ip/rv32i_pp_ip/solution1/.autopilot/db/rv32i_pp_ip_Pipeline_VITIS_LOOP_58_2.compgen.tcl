...
set id 33
set name rv32i_pp_ip_mux_325_32_1_1
...
eval "cg_default_interface_gen_dc { \
    id 68 \
    name e_to_f_target_pc_V \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_e_to_f_target_pc_V \
    op interface \
    ports { e_to_f_target_pc_V { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_nbc_out \
    op interface \
    ports { nbc_out { O 32 vector } nbc_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName rv32i_pp_ip_flow_control_loop_pipe_sequential_init_U
set CompName rv32i_pp_ip_flow_control_loop_pipe_sequential_init
