...
__attribute__((sdx_kernel("rv32i_pp_ip", 0))) void rv32i_pp_ip(
...
__attribute__((sdx_kernel("rv32i_pp_ip", 0))) void rv32i_pp_ip(
  ...
  unsigned int *nb_instruction,
  unsigned int *nb_cycle){
#line 27 "/home/bernard/book-2022.1/new_book_ip/rv32i_pp_ip/rv32i_pp_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=rv32i_pp_ip
# 31 "rv32i_pp_ip.cpp"

#line 6 "/home/bernard/book-2022.1/new_book_ip/rv32i_pp_ip/rv32i_pp_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=rv32i_pp_ip
# 31 "rv32i_pp_ip.cpp"
...
#pragma HLS ARRAY_PARTITION variable=reg_file dim=1 complete
 from_f_to_f_t f_to_f, f_from_f;
  ...
  unsigned int nbi;
  unsigned int nbc;
  VITIS_LOOP_50_1: for (reg_num_p1_t i=0; i<(1<<5); i++) reg_file[i] = 0;
