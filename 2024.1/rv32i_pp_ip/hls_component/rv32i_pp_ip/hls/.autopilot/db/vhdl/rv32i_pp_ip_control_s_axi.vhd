...
entity rv32i_pp_ip_control_s_axi is
generic (
...
end entity rv32i_pp_ip_control_s_axi;
...
--           others - reserved
-- 0x00028 : Data signal of nb_cycle
--           bit 31~0 - nb_cycle[31:0] (Read)
-- 0x0002c : Control signal of nb_cycle
...
architecture behave of rv32i_pp_ip_control_s_axi is
    ...
    constant ADDR_NB_CYCLE_DATA_0       : INTEGER := 16#00028#;
    constant ADDR_NB_CYCLE_CTRL         : INTEGER := 16#0002c#;
    ...
    component rv32i_pp_ip_control_s_axi_ram is
        generic (
    ...
    end component rv32i_pp_ip_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_code_ram
int_code_ram : rv32i_pp_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_code_ram_q1);
-- int_data_ram
int_data_ram : rv32i_pp_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "T2P",
     BYTES     => 4,
...
entity rv32i_pp_ip_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity rv32i_pp_ip_control_s_axi_ram;

architecture behave of rv32i_pp_ip_control_s_axi_ram is
