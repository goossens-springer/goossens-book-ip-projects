...
HLS_SOURCES = ../../../../../../testbench_par_multihart_ip.cpp ../../../../../../wb.cpp ../../../../../../type.cpp ../../../../../../print.cpp ../../../../../../new_cycle.cpp ../../../../../../multihart_ip.cpp ../../../../../../mem_access.cpp ../../../../../../mem.cpp ../../../../../../issue.cpp ../../../../../../immediate.cpp ../../../../../../fetch.cpp ../../../../../../execute.cpp ../../../../../../emulate.cpp ../../../../../../disassemble.cpp ../../../../../../decode.cpp ../../../../../../compute.cpp
...
$(ObjDir)/testbench_par_multihart_ip.o: ../../../../../../testbench_par_multihart_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../testbench_par_multihart_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_par_multihart_ip.d
