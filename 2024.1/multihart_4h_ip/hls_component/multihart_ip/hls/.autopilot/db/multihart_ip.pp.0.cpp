...
typedef ap_uint<15> code_address_t;
typedef ap_uint<15> w_data_address_t;
typedef ap_uint<15 +1> h_data_address_t;
typedef ap_uint<15 +2> b_data_address_t;
typedef ap_uint<(15 -2)> w_hart_data_address_t;
typedef ap_uint<(15 -2)+1> h_hart_data_address_t;
typedef ap_uint<(15 -2)+2> b_hart_data_address_t;
...
__attribute__((sdx_kernel("multihart_ip", 0))) void multihart_ip(
  ...
  unsigned int code_ram[(1<<15)],
  int data_ram[(1<<2)][(1<<(15 -2))],
...
static void init_file(
  ...
  reg_num_p1_t r1;
  reg_num_t r;
  VITIS_LOOP_30_1: for (h1=0; h1<(1<<2); h1++){
#pragma HLS UNROLL
 h = h1;
    VITIS_LOOP_33_2: for (r1=0; r1<(1<<5); r1++){
#pragma HLS UNROLL
 r = r1;
