...
architecture behave of multihart_ip_control_s_axi is
    ...
    constant ADDR_NB_INSTRUCTION_DATA_0   : INTEGER := 16#00030#;
    constant ADDR_NB_INSTRUCTION_CTRL     : INTEGER := 16#00034#;
    constant ADDR_NB_CYCLE_DATA_0         : INTEGER := 16#00040#;
    constant ADDR_NB_CYCLE_CTRL           : INTEGER := 16#00044#;
