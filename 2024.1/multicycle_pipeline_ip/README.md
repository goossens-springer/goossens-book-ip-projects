...
(1) create a "workspace" folder in the "2024.1/multicycle_pipeline_ip" one.
...
(4) in "Vitis IDE", create a "platform" and select the "multicycle_pipeline_ip/design_1_wrapper.xsa" file as the "Hardware Design"

(5) create a "hello_world" template associated to the just created platform, update the "helloworld.c" source file with the content of the "multicycle_pipeline_ip/helloworld.c" file, copy the "multicycle_pipeline_ip/test_mem_0_text.hex" file to the "workspace/hello_world/src" folder, build "hello_world"
