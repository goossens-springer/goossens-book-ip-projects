...
# 19 "multicycle_pipeline_ip.cpp"
static void init_reg_file(
  int *reg_file,
  bit_t *is_reg_computed){
  reg_num_p1_t r;
  VITIS_LOOP_23_1: for (r=0; r<(1<<5); r++){
    is_reg_computed[r] = 0;
    reg_file [r] = 0;
  }
}
...
__attribute__((sdx_kernel("multicycle_pipeline_ip", 0))) void multicycle_pipeline_ip(
  ...
  unsigned int *nb_instruction,
  unsigned int *nb_cycle){
#line 28 "/home/goossens/book-2022.1/new_book_ip/multicycle_pipeline_ip/multicycle_pipeline_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=multicycle_pipeline_ip
# 48 "multicycle_pipeline_ip.cpp"

#line 6 "/home/goossens/book-2022.1/new_book_ip/multicycle_pipeline_ip/multicycle_pipeline_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=multicycle_pipeline_ip
# 48 "multicycle_pipeline_ip.cpp"
