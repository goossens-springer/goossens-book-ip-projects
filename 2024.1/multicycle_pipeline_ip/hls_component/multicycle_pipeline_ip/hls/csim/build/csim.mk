...
HLS_SOURCES = ../../../../../../testbench_multicycle_pipeline_ip.cpp ../../../../../../compute.cpp ../../../../../../decode.cpp ../../../../../../disassemble.cpp ../../../../../../emulate.cpp ../../../../../../execute.cpp ../../../../../../fetch.cpp ../../../../../../immediate.cpp ../../../../../../issue.cpp ../../../../../../mem.cpp ../../../../../../mem_access.cpp ../../../../../../multicycle_pipeline_ip.cpp ../../../../../../print.cpp ../../../../../../type.cpp ../../../../../../wb.cpp
...
$(ObjDir)/testbench_multicycle_pipeline_ip.o: ../../../../../../testbench_multicycle_pipeline_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../testbench_multicycle_pipeline_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_multicycle_pipeline_ip.d
