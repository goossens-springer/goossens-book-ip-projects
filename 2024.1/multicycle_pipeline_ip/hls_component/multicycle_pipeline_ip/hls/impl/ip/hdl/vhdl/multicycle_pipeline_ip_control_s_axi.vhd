...
-- 0x40000 ~
-- 0x7ffff : Memory 'data_ram' (65536 * 32b)
...
architecture behave of multicycle_pipeline_ip_control_s_axi is
    ...
    constant ADDR_DATA_RAM_HIGH         : INTEGER := 16#7ffff#;
...
-- ----------------------- Instantiation------------------
-- int_code_ram
int_code_ram : multicycle_pipeline_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_code_ram_q1);
-- int_data_ram
int_data_ram : multicycle_pipeline_ip_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "T2P",
     BYTES     => 4,
