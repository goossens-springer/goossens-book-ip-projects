; ModuleID = '/home/goossens/goossens-book-ip-projects/2024.1/multicycle_pipeline_ip/workspace/hls_component/multicycle_pipeline_ip/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_multicycle_pipeline_ip_ir(i32 %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32768" %code_ram, i32* noalias nonnull "fpga.decayed.dim.hint"="65536" %data_ram, i32* noalias nocapture nonnull %nb_instruction, i32* noalias nocapture nonnull %nb_cycle) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([32768 x i32]* nonnull %0, [32768 x i32]* %code_ram_copy, [65536 x i32]* nonnull %1, [65536 x i32]* %data_ram_copy, i32* nonnull %nb_instruction, i32* nonnull align 512 %nb_instruction_copy, i32* nonnull %nb_cycle, i32* nonnull align 512 %nb_cycle_copy)
  call void @apatb_multicycle_pipeline_ip_hw(i32 %start_pc, [32768 x i32]* %code_ram_copy, [65536 x i32]* %data_ram_copy, i32* %nb_instruction_copy, i32* %nb_cycle_copy)
  call void @copy_back([32768 x i32]* %0, [32768 x i32]* %code_ram_copy, [65536 x i32]* %1, [65536 x i32]* %data_ram_copy, i32* %nb_instruction, i32* %nb_instruction_copy, i32* %nb_cycle, i32* %nb_cycle_copy)
...
define internal fastcc void @copy_in([32768 x i32]* noalias readonly, [32768 x i32]* noalias, [65536 x i32]* noalias readonly, [65536 x i32]* noalias, i32* noalias readonly, i32* noalias align 512, i32* noalias readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([32768 x i32]* noalias, [32768 x i32]* noalias readonly, [65536 x i32]* noalias, [65536 x i32]* noalias readonly, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_multicycle_pipeline_ip_hw(i32, [32768 x i32]*, [65536 x i32]*, i32*, i32*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([32768 x i32]* noalias, [32768 x i32]* noalias readonly, [65536 x i32]* noalias, [65536 x i32]* noalias readonly, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a65536i32([65536 x i32]* %2, [65536 x i32]* %3)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %4, i32* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %6, i32* align 512 %7)
...
define void @multicycle_pipeline_ip_hw_stub_wrapper(i32, [32768 x i32]*, [65536 x i32]*, i32*, i32*) #5 {
entry:
  call void @copy_out([32768 x i32]* null, [32768 x i32]* %1, [65536 x i32]* null, [65536 x i32]* %2, i32* null, i32* %3, i32* null, i32* %4)
  %5 = bitcast [32768 x i32]* %1 to i32*
  %6 = bitcast [65536 x i32]* %2 to i32*
  call void @multicycle_pipeline_ip_hw_stub(i32 %0, i32* %5, i32* %6, i32* %3, i32* %4)
  call void @copy_in([32768 x i32]* null, [32768 x i32]* %1, [65536 x i32]* null, [65536 x i32]* %2, i32* null, i32* %3, i32* null, i32* %4)
  ret void
}

declare void @multicycle_pipeline_ip_hw_stub(i32, i32* noalias nocapture nonnull readonly, i32* noalias nonnull, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull)
