...
#define XMULTICYCLE_PIPELINE_IP_CONTROL_ADDR_IP_CODE_RAM_BASE    0x4000
#define XMULTICYCLE_PIPELINE_IP_CONTROL_ADDR_IP_CODE_RAM_HIGH    0x7fff
#define XMULTICYCLE_PIPELINE_IP_CONTROL_WIDTH_IP_CODE_RAM        32
#define XMULTICYCLE_PIPELINE_IP_CONTROL_DEPTH_IP_CODE_RAM        4096
