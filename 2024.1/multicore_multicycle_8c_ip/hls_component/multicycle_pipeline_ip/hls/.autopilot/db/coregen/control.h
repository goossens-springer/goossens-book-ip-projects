...
#define CONTROL_ADDR_IP_NUM_DATA         0x0010
#define CONTROL_BITS_IP_NUM_DATA         32
#define CONTROL_ADDR_START_PC_DATA       0x0018
#define CONTROL_BITS_START_PC_DATA       32
#define CONTROL_ADDR_DATA_RAM_DATA       0x0020
#define CONTROL_BITS_DATA_RAM_DATA       64
#define CONTROL_ADDR_NB_INSTRUCTION_DATA 0x002c
#define CONTROL_BITS_NB_INSTRUCTION_DATA 32
#define CONTROL_ADDR_NB_INSTRUCTION_CTRL 0x0030
#define CONTROL_ADDR_NB_CYCLE_DATA       0x003c
#define CONTROL_BITS_NB_CYCLE_DATA       32
#define CONTROL_ADDR_NB_CYCLE_CTRL       0x0040
#define CONTROL_ADDR_IP_CODE_RAM_BASE    0x4000
#define CONTROL_ADDR_IP_CODE_RAM_HIGH    0x7fff
#define CONTROL_WIDTH_IP_CODE_RAM        32
#define CONTROL_DEPTH_IP_CODE_RAM        4096
