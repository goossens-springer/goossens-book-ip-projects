; ModuleID = '/home/goossens/book-2022.1/new_book_ip/rv32i_npp_bram_ip/rv32i_npp_bram_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_rv32i_npp_ip_hw(i32 %start_pc, i32* %2, i32* %3, i32* %nb_instruction_copy)
...
declare void @apatb_rv32i_npp_ip_hw(i32, i32*, i32*, i32*)
...
define void @rv32i_npp_ip_hw_stub_wrapper(i32, i32*, i32*, i32*) #4 {
entry:
  ...
  call void @rv32i_npp_ip_hw_stub(i32 %0, i32* %6, i32* %7, i32* %3)
