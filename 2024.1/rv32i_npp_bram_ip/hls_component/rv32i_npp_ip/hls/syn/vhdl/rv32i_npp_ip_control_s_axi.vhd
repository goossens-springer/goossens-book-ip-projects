...
--        others - reserved
-- 0x10 : Data signal of start_pc
--        bit 31~0 - start_pc[31:0] (Read/Write)
-- 0x14 : reserved
-- 0x18 : Data signal of nb_instruction
--        bit 31~0 - nb_instruction[31:0] (Read)
-- 0x1c : Control signal of nb_instruction
...
architecture behave of rv32i_npp_ip_control_s_axi is
    ...
    constant ADDR_START_PC_DATA_0       : INTEGER := 16#10#;
    constant ADDR_START_PC_CTRL         : INTEGER := 16#14#;
    constant ADDR_NB_INSTRUCTION_DATA_0 : INTEGER := 16#18#;
    constant ADDR_NB_INSTRUCTION_CTRL   : INTEGER := 16#1c#;
