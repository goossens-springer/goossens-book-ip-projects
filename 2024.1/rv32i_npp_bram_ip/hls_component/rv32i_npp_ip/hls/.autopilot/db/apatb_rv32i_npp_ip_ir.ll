; ModuleID = '/home/goossens/goossens-book-ip-projects/2024.1/rv32i_npp_bram_ip/workspace/hls_component/rv32i_npp_ip/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_rv32i_npp_ip_ir(i32 %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32768" %code_ram, i32* noalias nonnull "fpga.decayed.dim.hint"="32768" %data_ram, i32* noalias nocapture nonnull %nb_instruction) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_rv32i_npp_ip_hw(i32 %start_pc, [32768 x i32]* %code_ram_copy, [32768 x i32]* %data_ram_copy, i32* %nb_instruction_copy)
...
declare void @apatb_rv32i_npp_ip_hw(i32, [32768 x i32]*, [32768 x i32]*, i32*)
...
define void @rv32i_npp_ip_hw_stub_wrapper(i32, [32768 x i32]*, [32768 x i32]*, i32*) #5 {
entry:
...
declare void @rv32i_npp_ip_hw_stub(i32, i32* noalias nocapture nonnull readonly, i32* noalias nonnull, i32* noalias nocapture nonnull)
