...
//Command     : generate_target design_1_multicore_multicycle_wrapper.bd
//Design      : design_1_multicore_multicycle_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_1_multicore_multicycle_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  design_1_multicore_multicycle design_1_multicore_multicycle_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
