...
typedef ap_uint<(15 -2)> ip_code_address_t;
typedef ap_uint<15> w_data_address_t;
typedef ap_uint<15 +1> h_data_address_t;
typedef ap_uint<15 +2> b_data_address_t;
typedef ap_uint<(15 -2)> w_ip_data_address_t;
typedef ap_uint<(15 -2)+1> h_ip_data_address_t;
typedef ap_uint<(15 -2)+2> b_ip_data_address_t;
...
__attribute__((sdx_kernel("multicycle_pipeline_ip", 0))) void multicycle_pipeline_ip(
  ...
  unsigned int ip_code_ram[(1<<(15 -2))],
  int ip_data_ram[(1<<(15 -2))],
