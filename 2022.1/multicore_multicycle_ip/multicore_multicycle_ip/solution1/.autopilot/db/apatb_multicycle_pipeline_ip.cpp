...
// wrapc file define:
#define AUTOTB_TVIN_ip_num "../tv/cdatafile/c.multicycle_pipeline_ip.autotvin_ip_num.dat"
#define AUTOTB_TVOUT_ip_num "../tv/cdatafile/c.multicycle_pipeline_ip.autotvout_ip_num.dat"
...
#define AUTOTB_TVIN_ip_code_ram "../tv/cdatafile/c.multicycle_pipeline_ip.autotvin_ip_code_ram.dat"
#define AUTOTB_TVOUT_ip_code_ram "../tv/cdatafile/c.multicycle_pipeline_ip.autotvout_ip_code_ram.dat"
#define AUTOTB_TVIN_ip_data_ram "../tv/cdatafile/c.multicycle_pipeline_ip.autotvin_ip_data_ram.dat"
#define AUTOTB_TVOUT_ip_data_ram "../tv/cdatafile/c.multicycle_pipeline_ip.autotvout_ip_data_ram.dat"
...
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.multicycle_pipeline_ip.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.multicycle_pipeline_ip.autotvout_gmem.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_ip_num "../tv/rtldatafile/rtl.multicycle_pipeline_ip.autotvout_ip_num.dat"
#define AUTOTB_TVOUT_PC_start_pc "../tv/rtldatafile/rtl.multicycle_pipeline_ip.autotvout_start_pc.dat"
#define AUTOTB_TVOUT_PC_ip_code_ram "../tv/rtldatafile/rtl.multicycle_pipeline_ip.autotvout_ip_code_ram.dat"
#define AUTOTB_TVOUT_PC_ip_data_ram "../tv/rtldatafile/rtl.multicycle_pipeline_ip.autotvout_ip_data_ram.dat"
...
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.multicycle_pipeline_ip.autotvout_gmem.dat"
...
extern "C" void multicycle_pipeline_ip_hw_stub_wrapper(int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
{
transaction<32> tr(32768);
aesl_fh.read(AUTOTB_TVOUT_PC_ip_data_ram, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<4>((char*)__xlx_apatb_param_ip_data_ram, 32768);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > ip_data_ram_pc_buffer(32768);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 32768; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_ip_data_ram)[j*4+0] = ip_data_ram_pc_buffer[i].range(7, 0).to_int64();
...
tr.import<4>((char*)__xlx_apatb_param_ip_code_ram, 32768, 0);
  }
aesl_fh.write(AUTOTB_TVIN_ip_code_ram, tr.p, tr.tbytes);
}

  tcl_file.set_num(32768, &tcl_file.ip_code_ram_depth);
#else
...
tr.import<4>((char*)__xlx_apatb_param_ip_data_ram, 32768, 0);
  }
aesl_fh.write(AUTOTB_TVIN_ip_data_ram, tr.p, tr.tbytes);
}

  tcl_file.set_num(32768, &tcl_file.ip_data_ram_depth);
#else
...
multicycle_pipeline_ip_hw_stub_wrapper(__xlx_apatb_param_ip_num, __xlx_apatb_param_start_pc, __xlx_apatb_param_ip_code_ram, __xlx_apatb_param_ip_data_ram, __xlx_apatb_param_data_ram, __xlx_apatb_param_nb_instruction, __xlx_apatb_param_nb_cycle);
