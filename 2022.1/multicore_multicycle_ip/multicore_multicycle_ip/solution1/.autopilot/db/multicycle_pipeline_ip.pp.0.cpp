...
# 2 "<built-in>" 2
# 1 "multicycle_pipeline_ip.cpp" 2
# 1 "./debug_multicycle_pipeline_ip.h" 1
# 2 "multicycle_pipeline_ip.cpp" 2
# 1 "./multicycle_pipeline_ip.h" 1
...
# 4 "./multicycle_pipeline_ip.h" 2
# 96 "./multicycle_pipeline_ip.h"
...
__attribute__((sdx_kernel("multicycle_pipeline_ip", 0))) void multicycle_pipeline_ip(
  unsigned int ip_num,
  unsigned int start_pc,
  unsigned int ip_code_ram[(1<<(16 -1))],
  int ip_data_ram[(1<<(16 -1))],
  int data_ram [(1<<1)][(1<<(16 -1))],
  unsigned int *nb_instruction,
  unsigned int *nb_cycle);
# 3 "multicycle_pipeline_ip.cpp" 2
# 1 "./new_cycle.h" 1
...
# 4 "multicycle_pipeline_ip.cpp" 2
# 1 "./fetch.h" 1
...
void fetch(
  ...
  from_f_to_f_t *f_to_f,
  from_f_to_d_t *f_to_d);
# 5 "multicycle_pipeline_ip.cpp" 2
# 1 "./decode.h" 1
...
void decode(
  ...
  from_d_to_f_t *d_to_f,
  from_d_to_i_t *d_to_i);
# 6 "multicycle_pipeline_ip.cpp" 2
# 1 "./issue.h" 1
...
void issue(
  ...
  from_i_to_e_t *i_to_e,
  bit_t *i_wait);
# 7 "multicycle_pipeline_ip.cpp" 2
# 1 "./execute.h" 1
...
void execute(
  ...
  from_e_to_f_t *e_to_f,
  from_e_to_m_t *e_to_m);
# 8 "multicycle_pipeline_ip.cpp" 2
# 1 "./mem_access.h" 1
...
void mem_access(
  ...
  int data_ram[][(1<<(16 -1))],
  from_m_to_w_t *m_to_w);
# 9 "multicycle_pipeline_ip.cpp" 2
# 1 "./wb.h" 1
...
void write_back(
  ...
  int *reg_file,
  bit_t *is_reg_computed);
# 10 "multicycle_pipeline_ip.cpp" 2
# 21 "multicycle_pipeline_ip.cpp"
static void init_reg_file(
  ip_num_t ip_num,
  int *reg_file,
  bit_t *is_reg_computed){
  reg_num_p1_t r;
  VITIS_LOOP_26_1: for (r=0; r<(1<<5); r++){
#pragma HLS UNROLL
 is_reg_computed[r] = 0;
    if (r==10)
      reg_file [r] = ip_num;
...
__attribute__((sdx_kernel("multicycle_pipeline_ip", 0))) void multicycle_pipeline_ip(
  ...
  unsigned int *nb_instruction,
  unsigned int *nb_cycle){
#line 29 "/home/goossens/book-2022.1/new_book_ip/multicore_multicycle_ip/multicore_multicycle_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=multicycle_pipeline_ip
# 59 "multicycle_pipeline_ip.cpp"

#line 6 "/home/goossens/book-2022.1/new_book_ip/multicore_multicycle_ip/multicore_multicycle_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=multicycle_pipeline_ip
# 59 "multicycle_pipeline_ip.cpp"
