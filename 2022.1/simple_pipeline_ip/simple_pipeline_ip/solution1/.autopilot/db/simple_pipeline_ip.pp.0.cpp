...
# 2 "<built-in>" 2
# 1 "simple_pipeline_ip.cpp" 2
# 1 "./debug_simple_pipeline_ip.h" 1
# 2 "simple_pipeline_ip.cpp" 2
# 1 "./simple_pipeline_ip.h" 1
...
# 5 "./simple_pipeline_ip.h" 2
# 89 "./simple_pipeline_ip.h"
...
__attribute__((sdx_kernel("simple_pipeline_ip", 0))) void simple_pipeline_ip(
  unsigned int start_pc,
  unsigned int code_ram[(1<<16)],
  int data_ram[(1<<16)],
  unsigned int *nb_instruction);
# 3 "simple_pipeline_ip.cpp" 2
# 1 "./fetch_decode.h" 1
...
__attribute__((sdx_kernel("simple_pipeline_ip", 0))) void simple_pipeline_ip(
  ...
  int data_ram[(1<<16)],
  unsigned int *nb_instruction){
#line 25 "/home/goossens/goossens-springer-book/2022.1/book_experiments/simple_pipeline_ip/simple_pipeline_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=simple_pipeline_ip
# 27 "simple_pipeline_ip.cpp"

#line 6 "/home/goossens/goossens-springer-book/2022.1/book_experiments/simple_pipeline_ip/simple_pipeline_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=simple_pipeline_ip
# 27 "simple_pipeline_ip.cpp"
...
#pragma HLS ARRAY_PARTITION variable=reg_file dim=1 complete
 from_f_to_f_t f_to_f, f_from_f;
  ...
  bit_t is_running;
  unsigned int nbi;
  VITIS_LOOP_42_1: for (int i=0; i<(1<<5); i++) reg_file[i] = 0;
