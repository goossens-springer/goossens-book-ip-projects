...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"simple_pipeline_ip","role":"start","value":"0","valid_bit":"0"},{"name":"simple_pipeline_ip","role":"continue","value":"0","valid_bit":"4"},{"name":"simple_pipeline_ip","role":"auto_start","value":"0","valid_bit":"7"},{"name":"start_pc","role":"data","value":"16"},{"name":"code_ram","role":"data","value":"262144"},{"name":"data_ram","role":"data","value":"524288"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"simple_pipeline_ip","role":"start","value":"0","valid_bit":"0"},{"name":"simple_pipeline_ip","role":"done","value":"0","valid_bit":"1"},{"name":"simple_pipeline_ip","role":"idle","value":"0","valid_bit":"2"},{"name":"simple_pipeline_ip","role":"ready","value":"0","valid_bit":"3"},{"name":"simple_pipeline_ip","role":"auto_start","value":"0","valid_bit":"7"},{"name":"nb_instruction","role":"data","value":"24"}, {"name":"nb_instruction","role":"valid","value":"28","valid_bit":"0"},{"name":"data_ram","role":"data","value":"524288"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "7"],
		...
		"Port" : [
			...
			{"Name" : "code_ram", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2_fu_239", "Port" : "code_ram", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "data_ram", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2_fu_239", "Port" : "data_ram", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "nb_instruction", "Type" : "Vld", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_42_1_fu_203", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "simple_pipeline_ip_Pipeline_VITIS_LOOP_42_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_42_1_fu_203.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2_fu_239", "Parent" : "0", "Child" : ["4", "5", "6"],
		"CDFG" : "simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2_fu_239.mux_325_32_1_1_U33", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2_fu_239.mux_325_32_1_1_U34", "Parent" : "3"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2_fu_239.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"},
...
set ArgLastReadFirstWriteLatency {
	simple_pipeline_ip {
		...
		data_ram {Type IO LastRead 2 FirstWrite 3}
		nb_instruction {Type O LastRead -1 FirstWrite 4}}
	simple_pipeline_ip_Pipeline_VITIS_LOOP_42_1 {
	...
	simple_pipeline_ip_Pipeline_VITIS_LOOP_47_2 {
		...
		code_ram {Type I LastRead 0 FirstWrite -1}
		data_ram {Type IO LastRead 2 FirstWrite 3}
		nbi_1_out {Type O LastRead -1 FirstWrite 4}}}
