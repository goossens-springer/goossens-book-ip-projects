...
# 2 "<built-in>" 2
# 1 "multihart_ip.cpp" 2
# 1 "./debug_multihart_ip.h" 1
# 2 "multihart_ip.cpp" 2
# 1 "./multihart_ip.h" 1
...
typedef ap_uint<(16 -2)> ip_code_address_t;
typedef ap_uint<16> w_data_address_t;
typedef ap_int <16> s_data_address_t;
typedef ap_uint<16 +1> h_data_address_t;
typedef ap_uint<16 +2> b_data_address_t;
typedef ap_uint<(16 -2)> w_ip_data_address_t;
typedef ap_uint<(16 -2)+1> h_ip_data_address_t;
typedef ap_uint<(16 -2)+2> b_ip_data_address_t;
typedef ap_uint<((16 -2)-1)> w_hart_data_address_t;
typedef ap_uint<((16 -2)-1)+1> h_hart_data_address_t;
typedef ap_uint<((16 -2)-1)+2> b_hart_data_address_t;
...
typedef ap_uint<2> ip_num_t;
typedef ap_uint<1 +1> hart_num_p1_t;
typedef ap_uint<1> hart_num_t;
typedef ap_uint<(1<<1)> hart_set_t;
...
__attribute__((sdx_kernel("multihart_ip", 0))) void multihart_ip(
  unsigned int ip_num,
  unsigned int running_hart_set,
  unsigned int start_pc [(1<<1)],
  unsigned int ip_code_ram[(1<<(16 -2))],
  int ip_data_ram[(1<<1)][(1<<((16 -2)-1))],
  int data_ram [(1<<2)][(1<<1)][(1<<((16 -2)-1))],
  unsigned int *nb_instruction,
  unsigned int *nb_cycle);
# 3 "multihart_ip.cpp" 2
# 1 "./new_cycle.h" 1
...
void mem_access(
  ...
  int ip_data_ram[][(1<<((16 -2)-1))],
  int data_ram[][(1<<1)][(1<<((16 -2)-1))],
  m_state_t *m_state,
  from_m_to_w_t *m_to_w,
  bit_t *m_state_is_full);
# 9 "multihart_ip.cpp" 2
# 1 "./wb.h" 1
...
static void init_file(
  ...
  reg_num_p1_t r1;
  reg_num_t r;
  VITIS_LOOP_28_1: for (h1=0; h1<(1<<1); h1++){
#pragma HLS UNROLL
 h = h1;
    VITIS_LOOP_31_2: for (r1=0; r1<(1<<5); r1++){
#pragma HLS UNROLL
 r = r1;
      ...
      if (r==10)
        ...
        reg_file [h][r] = ((int)(ip_num+1))<<((16 -2)+2);
      else
        reg_file [h][r] = 0;
    }
  }
...
static void init_exit(
  ...
  hart_num_t h;
  bit_t h_running;
  VITIS_LOOP_52_1: for (h1=0; h1<(1<<1); h1++){
#pragma HLS UNROLL
 h = h1;
...
static void running_cond_update(
  ...
  bit_t cond;
  cond = 0;
  VITIS_LOOP_66_1: for (h1=0; h1<(1<<1); h1++){
#pragma HLS UNROLL
 h = h1;
...
__attribute__((sdx_kernel("multihart_ip", 0))) void multihart_ip(
  ...
  unsigned int *nb_instruction,
  unsigned int *nb_cycle){
#line 29 "/home/goossens/book-2022.1/new_book_ip/multicore_multihart_ip/multicore_multihart_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=multihart_ip
# 109 "multihart_ip.cpp"

#line 6 "/home/goossens/book-2022.1/new_book_ip/multicore_multihart_ip/multicore_multihart_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=multihart_ip
# 109 "multihart_ip.cpp"
