...
typedef ap_uint<(16 -3)> w_hart_data_address_t;
typedef ap_uint<(16 -3)+1> h_hart_data_address_t;
typedef ap_uint<(16 -3)+2> b_hart_data_address_t;
...
typedef ap_uint<3 + 1> hart_num_p1_t;
typedef ap_uint<3> hart_num_t;
typedef ap_uint<(1<<3)> hart_set_t;
...
__attribute__((sdx_kernel("multihart_ip", 0))) void multihart_ip(
  ...
  unsigned int start_pc[(1<<3)],
  unsigned int code_ram[(1<<16)],
  int data_ram[(1<<3)][(1<<(16 -3))],
...
static void init_file(
  ...
  reg_num_p1_t r1;
  reg_num_t r;
  VITIS_LOOP_26_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
    VITIS_LOOP_29_2: for (r1=0; r1<(1<<5); r1++){
#pragma HLS UNROLL
 r = r1;
...
static void init_exit(
  ...
  hart_num_t h;
  bit_t h_running;
  VITIS_LOOP_48_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
...
static void running_cond_update(
  ...
  bit_t cond;
  cond = 0;
  VITIS_LOOP_62_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
...
__attribute__((sdx_kernel("multihart_ip", 0))) void multihart_ip(
  ...
  unsigned int *nb_instruction,
  unsigned int *nb_cycle){
#line 29 "/home/goossens/goossens-springer-book/2022.1/book_experiments/multihart_ip/multihart_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=multihart_ip
# 103 "multihart_ip.cpp"

#line 6 "/home/goossens/goossens-springer-book/2022.1/book_experiments/multihart_ip/multihart_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=multihart_ip
# 103 "multihart_ip.cpp"
