...
void init_i_state(bit_t *i_state_is_full){
  hart_num_p1_t h1;
  hart_num_t h;
  VITIS_LOOP_11_1: for (h1=0; h1<(1<<3); h1++){
#pragma HLS UNROLL
 h = h1;
    i_state_is_full[h] = 0;
  }
...
static void select_hart(
  ...
  bit_t c [(1<<3)];
  bit_t is_locked_1[(1<<3)];
  bit_t is_locked_2[(1<<3)];
  bit_t wait_12 [(1<<3)];
  is_locked_1 [0] =
  ...
  c[2] = (i_state_is_full[2] && !e_state_is_full[2] && !wait_12[2]);
  c[3] = (i_state_is_full[3] && !e_state_is_full[3] && !wait_12[3]);
  ...
  c[4] = (i_state_is_full[4] && !e_state_is_full[4] && !wait_12[4]);
  c[5] = (i_state_is_full[5] && !e_state_is_full[5] && !wait_12[5]);
  c[6] = (i_state_is_full[6] && !e_state_is_full[6] && !wait_12[6]);
  c[7] = (i_state_is_full[7] && !e_state_is_full[7] && !wait_12[7]);
# 166 "issue.cpp"
