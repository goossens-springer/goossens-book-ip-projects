...
#(parameter
    ...
    input  wire [15:0]                   code_ram_address0,
    input  wire                          code_ram_ce0,
    output wire [31:0]                   code_ram_q0,
    input  wire [15:0]                   data_ram_address0,
...
localparam
    ...
    ADDR_IER                     = 20'h00008,
    ADDR_ISR                     = 20'h0000c,
    ADDR_RUNNING_HART_SET_DATA_0 = 20'h00010,
    ADDR_RUNNING_HART_SET_CTRL   = 20'h00014,
    ADDR_NB_INSTRUCTION_DATA_0   = 20'h00020,
    ADDR_NB_INSTRUCTION_CTRL     = 20'h00024,
    ADDR_NB_CYCLE_DATA_0         = 20'h00030,
    ADDR_NB_CYCLE_CTRL           = 20'h00034,
    ADDR_START_PC_BASE           = 20'h00018,
    ADDR_START_PC_HIGH           = 20'h0001f,
    ADDR_CODE_RAM_BASE           = 20'h40000,
    ADDR_CODE_RAM_HIGH           = 20'h7ffff,
    ADDR_DATA_RAM_BASE           = 20'h80000,
    ADDR_DATA_RAM_HIGH           = 20'hbffff,
    WRIDLE                       = 2'd0,
    WRDATA                       = 2'd1,
    WRRESP                       = 2'd2,
    WRRESET                      = 2'd3,
...
//------------------------Local signal-------------------
    ...
    wire [15:0]                   int_code_ram_address0;
...
assign RVALID  = (rstate == RDDATA) & !int_start_pc_read & !int_code_ram_read & !int_data_ram_read;
...
assign int_code_ram_address1 = ar_hs? raddr[17:2] : waddr[17:2];
...
assign int_data_ram_address1 = ar_hs? raddr[17:2] : waddr[17:2];
