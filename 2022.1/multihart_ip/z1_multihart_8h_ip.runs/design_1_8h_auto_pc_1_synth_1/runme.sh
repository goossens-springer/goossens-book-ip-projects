...
HD_PWD='/home/bernard/book-2022.1/new_book_ip/multihart_ip/z1_multihart_8h_ip.runs/design_1_8h_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_8h_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_8h_auto_pc_1.tcl
