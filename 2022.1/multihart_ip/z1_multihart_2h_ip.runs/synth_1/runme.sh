...
HD_PWD='/home/goossens/book-2022.1/new_book_ip/multihart_ip/z1_multihart_2h_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_2h_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_2h_wrapper.tcl
