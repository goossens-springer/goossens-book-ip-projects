; ModuleID = '/home/bernard/book-2022.1/new_book_ip/rv32i_pp_ip/rv32i_pp_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_rv32i_pp_ip_ir(i32 %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="65536" %code_ram, i32* noalias nonnull "fpga.decayed.dim.hint"="65536" %data_ram, i32* noalias nocapture nonnull %nb_instruction, i32* noalias nocapture nonnull %nb_cycle) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_rv32i_pp_ip_hw(i32 %start_pc, i32* %2, i32* %3, i32* %nb_instruction_copy, i32* %nb_cycle_copy)
...
declare void @apatb_rv32i_pp_ip_hw(i32, i32*, i32*, i32*, i32*)
...
define void @rv32i_pp_ip_hw_stub_wrapper(i32, i32*, i32*, i32*, i32*) #4 {
entry:
  ...
  call void @rv32i_pp_ip_hw_stub(i32 %0, i32* %7, i32* %8, i32* %3, i32* %4)
  call void @copy_in([65536 x i32]* null, [65536 x i32]* %5, [65536 x i32]* null, [65536 x i32]* %6, i32* null, i32* %3, i32* null, i32* %4)
  ret void
}

declare void @rv32i_pp_ip_hw_stub(i32, i32*, i32*, i32*, i32*)
