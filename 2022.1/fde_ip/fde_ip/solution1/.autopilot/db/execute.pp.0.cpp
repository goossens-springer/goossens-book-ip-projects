...
#pragma HLS INLINE
 switch(d_i.func3){
    case 0 : return (rv1 == rv2);
    case 1 : return (rv1 != rv2);
    case 2 :
    case 3 : return 0;
    case 4 : return (rv1 < rv2);
    case 5 : return (rv1 >= rv2);
    case 6: return (unsigned int)rv1 < (unsigned int)rv2;
    case 7: return (unsigned int)rv1 >= (unsigned int)rv2;
  }
  return 0;
}
...
#pragma HLS INLINE
 bit_t f7_6 = d_i.func7>>5;
  ...
  if (r_type)
    ...
    shift = d_i.rs2;
  switch(d_i.func3){
    case 0 : if (r_type && f7_6)
                 result = rv1 - rv2;
               else
                 result = rv1 + rv2;
               break;
    case 1 : result = rv1 << shift;
               break;
    case 2 : result = rv1 < rv2;
               break;
    case 3: result = (unsigned int)rv1 < (unsigned int)rv2;
               break;
    case 4 : result = rv1 ^ rv2;
               break;
    case 5 : if (f7_6)
                 result = rv1 >> shift;
               else
               ...
               break;
    case 6 : result = rv1 | rv2;
               break;
    case 7 : result = rv1 & rv2;
               break;
  }
  return result;
}
 ...
 int imm12 = ((int)d_i.imm)<<12;
  ...
  switch(d_i.type){
    case 1:
      ...
      break;
    case 2:
      if (d_i.opcode == 0b11001)
        result = npc4;
      else if (d_i.opcode == 0b00000)
        result = 0;
      else if (d_i.opcode == 0b00100)
