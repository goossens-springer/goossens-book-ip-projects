...
__attribute__((sdx_kernel("fde_ip", 0))) void fde_ip(
 ...
 *is_running = (instruction != 0x8067 || pc != 0);
}
...
__attribute__((sdx_kernel("fde_ip", 0))) void fde_ip(
  ...
  unsigned int code_ram[(1<<16)],
  unsigned int *nb_instruction){
#line 23 "/home/bernard/book-2022.1/new_book_ip/fde_ip/fde_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fde_ip
# 29 "fde_ip.cpp"

#line 6 "/home/bernard/book-2022.1/new_book_ip/fde_ip/fde_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fde_ip
# 29 "fde_ip.cpp"
...
#pragma HLS ARRAY_PARTITION variable=reg_file dim=1 complete
 instruction_t instruction;
  ...
  unsigned int nbi;
  decoded_instruction_t d_i;
  VITIS_LOOP_41_1: for (int i=0; i<(1<<5); i++) reg_file[i] = 0;
  pc = start_pc;
  nbi = 0;
  VITIS_LOOP_44_2: do{
