; ModuleID = '/home/bernard/book-2022.1/new_book_ip/fde_ip/fde_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_fde_ip_ir(i32 %start_pc, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="65536" %code_ram, i32* noalias nocapture nonnull %nb_instruction) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_fde_ip_hw(i32 %start_pc, i32* %1, i32* %nb_instruction_copy)
...
declare void @apatb_fde_ip_hw(i32, i32*, i32*)
...
define void @fde_ip_hw_stub_wrapper(i32, i32*, i32*) #4 {
entry:
  ...
  call void @fde_ip_hw_stub(i32 %0, i32* %4, i32* %2)
  call void @copy_in([65536 x i32]* null, [65536 x i32]* %3, i32* null, i32* %2)
  ret void
}

declare void @fde_ip_hw_stub(i32, i32*, i32*)
