...
HLS_SOURCES = ../../../../testbench_rv32i_npp_ip.cpp ../../../../type.cpp ../../../../rv32i_npp_ip.cpp ../../../../print.cpp ../../../../immediate.cpp ../../../../fetch.cpp ../../../../execute.cpp ../../../../emulate.cpp ../../../../disassemble.cpp ../../../../decode.cpp
...
$(ObjDir)/testbench_rv32i_npp_ip.o: ../../../../testbench_rv32i_npp_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../testbench_rv32i_npp_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
$(ObjDir)/rv32i_npp_ip.o: ../../../../rv32i_npp_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../rv32i_npp_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
