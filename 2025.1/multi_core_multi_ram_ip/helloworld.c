...
#define LOG_RAM_SIZE       15 //2^LOG_RAM_SIZE words
...
int main(){
  cfg_ptr0 = XMulti_core_multi_ram_ip_LookupConfig(XPAR_XMULTI_CORE_MULTI_RAM_IP_0_BASEADDR);
  ...
  cfg_ptr1 = XMulti_core_multi_ram_ip_LookupConfig(XPAR_XMULTI_CORE_MULTI_RAM_IP_1_BASEADDR);
