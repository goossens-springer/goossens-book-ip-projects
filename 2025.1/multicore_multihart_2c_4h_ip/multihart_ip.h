...
#define LOG_IP_CODE_RAM_SIZE   (LOG_CODE_RAM_SIZE-LOG_NB_IP)//in words
...
typedef ap_uint<LOG_IP_CODE_RAM_SIZE>     ip_code_address_t;
typedef ap_uint<LOG_DATA_RAM_SIZE>        w_data_address_t;
typedef ap_int <LOG_DATA_RAM_SIZE>        s_data_address_t;
typedef ap_uint<LOG_DATA_RAM_SIZE+1>      h_data_address_t;
typedef ap_uint<LOG_DATA_RAM_SIZE+2>      b_data_address_t;
typedef ap_uint<LOG_IP_DATA_RAM_SIZE>     w_ip_data_address_t;
typedef ap_uint<LOG_IP_DATA_RAM_SIZE+1>   h_ip_data_address_t;
typedef ap_uint<LOG_IP_DATA_RAM_SIZE+2>   b_ip_data_address_t;
...
typedef struct w_state_s{
  ...
  bit_t                 is_load;
  bit_t                 is_ret;
  //value from mem_access
  //result from execute
  //separate to allow II=2 pipelining
  int                   value;
  int                   result;
#ifndef __SYNTHESIS__
  ip_code_address_t     fetch_pc;
